...
public class STARS
{
    ...
    */
    ...
    /**
     * Check if an index is under a course
     *
     * @param indexNo  index number to check
     * @param courseID course id to check
     * @return true if the index belongs to the course
     */
    ...
    /**
     * Checks whether the start date entered is today or after today to prevent users from entering dates that have already passed
     * @param start Start Date in {@link String} format
     * @return true if start date is after today
     */
    public boolean checkStartDateIsValid (String start)
    {
        Date startDate;
