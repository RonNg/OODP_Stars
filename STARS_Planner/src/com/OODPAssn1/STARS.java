...
/**
 * The <i>STARS</i> class retrieves information from CourseManagers and UserManagers and handles their data
 * so that CourseManager and UserManager are completely separated and will not have dependencies on each other. <br>
 * In short, STARS does the heavy lifting while CourseManager and UserManager should only be concerned with handling their own data.
 *
 *
 */
public class STARS
...
*/
    ...
    /**
     * Validates the login information entered and returns the student's matriculation number of authenticated
     *
     * @param username username of student
     * @param password password of student
     * @return Matriculation number of authenticated student. <br>
     * <i>null</i> if not authenticated
     */
...
//------------------------Method to check current date is within access period-----------------------------
    ...
    /**
     * Returns the access period information in a String
     *
     * @return access period information in String object
     */
     ...
     */
    public boolean checkIndexExist (int indexNo)
    {
    ...
    /**
     * Returns a boolean depending on whether access to STARS should be allowed or not
     *
     * @return true if access to STARS is allowed
     */
    ...
    /**
     * Checks if the date format entered is valid
     *
    ...
    /**
     * Checks if the start date is equals to the date today or after today
     *
     * @param start start date to check
     * @return true if start date is equals to the date today or after today
     */
    public boolean checkIfStartDateValid (String start)
    {
    ...
    {
        return userManager.doesUserExist(username);
    }


    /**
     * Check if theres a timing clash between two index
     *
     * @param index1 the index to check against the second argument
     * @param index2 the index to check against the first argument
     * @return Returns "NO CLASH" if there isn't a clash between the indexes. <br>
     * If there's a clash, builds a string and returns it with the details of the clash
     */
    ...
    /**
     * Check if the index number is in the course
     *
     * @param indexNo  index number to check
     * @param courseID course id to check
     * @return true if the index in inside the course
     */
    ...
    /**
     * Check if the two indexes are in the same course
     *
     * @param indexNo1 the index to check against the second argument
     * @param indexNo2 the index to check against the first argument
     * @return true if they are in the same course
     */
    ...
    /**
     * Sets the start and end dates of the access period
     *
...
=======
    ...
    {
        if (checkIndexExist(indexNo) == false || currentLogOnUser.getType() != User.USER_TYPE.STUDENT)
...
>>>>>>> 32ecdb9f3828e0330c2517b866a024cb9cb5443a
        ...
        if (result[0] != "ERROR")
        {
            ...
            if (result[0] == "HANDLE")
            {
                ...
                for (int i = 0; i < sEnrollIndex.size(); ++i)
                {
                    ...
                    if (!cClash.equals("NO CLASH"))
                    {
                        if (!cClash.equals("SAME COURSE"))
                        {
    ...
    /**
     * Swaps index of two students
     *
     * @param firstIndex   Index to swap for the currently logged in student
     * @param secondMatric Matriculation number of the second student
     * @param secondIndex  Index of the second student to swap with the first student
     * @return true if successfully swapped
     */
    public boolean student_SwapIndex (int firstIndex, String secondMatric, int secondIndex)
    {
        ...
        return false; //Failed to swap index
...
/*
    ...
    /**
     * Adds course in the CourseManager
     *
    ...
    /**
     * Deletes a course via its Course ID
     * @param cId Course ID of the course to delete
     * @return true if successfully deleted
     */
    public String admin_DeleteCourse (String cId)
    {
    ...
    /**
     * Adds an index into an existing course
     *
     * @param courseId     Couse ID to add the index into
     * @param indexNoToAdd Index number to add
     * @param maxStudent   Maximum number of students the index can accomodate
     * @return true if successful
     */
    ...
    /**
     * Adds a lecture timeslot into a course
     *
     * @param courseId       Course ID to add lecture timeslot into
     * @param timeSlotDayStr Day of the lecture
     * @param startTimeHH    Start time (hour) (in 24 hours) of this lecture
     * @param startTimeMM    Start time (minutes) of this lecture
    ...
    /**
     * Adds a lab timeslot into an index
     *
     * @param indexNo     Index number to add
     * @param dayStr      Day of the lab
     ...
     * @param labLocation Location of the lab
     * @return true if successfully added
     */
    ...
    /**
     * Adds a tutorial timeslot into an index
     *
     * @param indexNo     Index number to add
     * @param dayStr      Day of the tutorial
     ...
     * @param tutLocation Location of the tutorial
     * @return true if successfully added
     */
    ...
    /**
     * Deletes a lecture timeslot from a course
     *
     * @param courseId  Course ID to delete the lecture timeslot from
     * @param lecSelect index of lecture timeslot to delete
     * @return true if successfully deleted
     */
    ...
    /**
     * Deletes either a lab or tutorial timeslot from the Course ID
     *
     * @param courseId   Course ID to delete the lab or tutorial timeslot
     * @param indexToGet Index number to delete the timeslot from
     * @param choice     Index of the timeslot to delete
     * @return True if successful
     */
    public boolean admin_DeleteLabTutTimeSlot (String courseId, int indexToGet, int choice)
    {
        ...
        return tempIndex.deleteTutLabTimeSlot(tempIndex.getTutLabTimeSlotList().get(choice - 1));
    }

    /**
     * Get lab/tutorial list
     *
     ...
     *
     * @return list of students in String
     */
    ...
    /**
     * Gets all lecture time slots in a Course ID
     *
     * @param courseId Course ID to get the timeslots from
     * @return List of lectures of the specified Course ID in String
     */
    ...
    /**
     * Deletes an index number from the entire course list
     *
     * @param indexNo Index number to delete
     * @return List of students who were de-enrolled from this index due to the deletion
     */
    public String admin_deleteIndexFromCourse (int indexNo)
    {
        String rtrStr = "";
    ...
    /**
     * Checks vacancies in the specified index
     *
     * @param indexNo Index number to check vacancy
     * @return Number of vacancies in the index in String
     */
    ...
    /**
     * Adds a student into the user list
     *
     * @param name        Name of student
     * @param email       Email of student
     * @param matricNo    Matriculation number of student
     * @param contact     Contact number of student
     * @param genderStr   Gender of student
     * @param nationality Nationality of student
     * @param username    Username for student login
     * @param password    Password for student login
     * @return true if successfully added
     */
    ...
    /**
     * Checks if student exists in the user list
     *
     * @param matricNo Matriculation number of student to check
    ...
    /**
     * Saves all data into the database file
     *
     * @return True if successful
     */
   ...
   /*==================================================
    ...
    /**
     * Returns the entire course list in a String object for printing
     *
     * @return List of the entire courses in CourseManager
     */
    ...
    /**
     * Prints details of a course such as indexes, timeslots of labs and tutorials etc.
     *
     * @param course Course details to print
     * @return Details of the course in String
     */
    public String printCourseDetails (String course)
    {
        ...
        if (!course.equals(""))
        {
            ...
            courseList.add(courseManager.getCourseByCourseId(course));
        }
        else
        {
    ...
    /**
     * Formats a String to contain the information of a Student
     * @param s Student to format into String
     * @param retStr String to format and return
    ...
    /**
     * Returns a String containing all information of students in a course
     * @param courseId Course to print the student information from
     * @return Formatted String containing list of students and their information in the course
     */
    public String printStudentsInCourse (String courseId) {
        ...
        //if course does not exists
        if (!this.checkCourseExist(courseId))
            return courseNotFoundErr;
